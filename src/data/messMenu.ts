...
export const MESS_MENU_ITEMS: MessMenuItem[] = [
  ...
  { id: 'm3', name: 'Steamed White Rice (1 bowl)', category: 'Hostel Mess', calories: 195, protein: 4, carbs: 42, fat: 0.5, icon: '🍚' },
  { id: 'm4', name: 'Rajma Curry (1 bowl)', category: 'Hostel Mess', calories: 210, protein: 11, carbs: 32, fat: 4, icon: '🍛' },
  { id: 'm5', name: 'Chhole Masala (1 bowl)', category: 'Hostel Mess', calories: 230, protein: 10, carbs: 34, fat: 6, icon: '🍛' },
  ...
  { id: 'm14', name: 'Aloo Paratha (1 with butter)', category: 'Hostel Mess', calories: 310, protein: 6, carbs: 44, fat: 13, icon: '🥞' },
...
export const BUDGET_PROTEIN_HACKS: ProteinHack[] = [
  ...
  },
  {
    ...
    proteinGrams: 19,
    prepTime: '0 mins (From canteen / mess counter)',
